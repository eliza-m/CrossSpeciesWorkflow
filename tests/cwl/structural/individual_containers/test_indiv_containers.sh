...
CWLSCRIPTS=${CWL_HOME}/cwl/structural/indiv_containers/

TESTFOLDER=${CWL_HOME}/tests/cwl/structural/
...
# ln -s /path/to/host/db/folder/uniref50 ${CWL_HOME}/test/cwl/data/databases/uniref50
...
# ln -s /path/to/host/db/folder/uniprot20_2016_02 ${CWL_HOME}/test/cwl/data/databases/uniprot20_2016_02
